<template>
  <el-collapse >
    <el-collapse-item name="1" class="collap">
      ...
      <el-row>
        <el-col style="width:600px;margin-left:100px"><schoolAll /></el-col>
        <el-col style="width:600px;margin-left:100px"><schoolYear /></el-col>
      </el-row>
    </el-collapse-item>
    ...
    <el-collapse-item name="4" class="collap">
      ...
      <el-row>
        <el-col style="width:1000px;margin-left:100px"><thesisYear /></el-col>
      </el-row>
    </el-collapse-item>
  </el-collapse>
</template>
...
import thesisYear from './echarts/thesisYear'
export default {
  components: {
    schoolAll,
    majorAll,
