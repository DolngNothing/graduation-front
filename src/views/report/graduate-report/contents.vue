...
export default {
  ...
  data() {
    return {
      ...
      portList: [],
      year: '',
      portColunm: { admissionId: '', username: '', majorname: '', education: '', graduateDate: '', city: '', district: '', school: '', idcard: '' },
  ...
  methods: {
    ...
    export2Excel() {
      require.ensure([], () => {
        ...
        const tHeader = ['准考证号', '学生姓名', '专业', '毕业学历', '毕业时间', '城市', '地区', '学校', '身份证号码']
        const filterVal = ['admissionId', 'username', 'majorname', 'education', 'graduateDate', 'city', 'district', 'school', 'idcard']
        this.multipleSelection.forEach(item => {
          ...
          this.portColunm.education = item.student.education
          ...
          this.portColunm.graduateDate = item.graduateDate
